...
export default function FilterCatMedium() {
  return (
    ...
    <body>
      ...
      <bodydDogs>
        ...
        <section class="containerAnimalBox">
          ...
          <div class="cardAnimalBox">
            <div class="cardAnimalBox-image cardcat-3"></div>
              <h2>Bob</h2>
              <p><b>Name:</b> Bob</p>
              <p><b>Sex:</b> Male</p>
              <p><b>Age:</b> 5 Years</p>
              <p><b>Coat Type:</b> Medium</p>
              <a href="http://localhost:3000/AdoptAnimal/CATS/Cat3"><h3>More Informations</h3></a>
          </div>
          <div class="cardAnimalBox">
            <div class="cardAnimalBox-image cardcat-5"></div>
              <h2>Baunilha</h2>
              <p><b>Name:</b> Baunilha</p>
              <p><b>Sex:</b> Female</p>
              <p><b>Age:</b> 7 Years</p>
              <p><b>Size:</b> Medium</p>
              <a href="http://localhost:3000/AdoptAnimal/CATS/Cat5"><h3>More Informations</h3></a>
          </div>
        </section>
    </body>
  );
