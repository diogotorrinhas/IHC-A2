    ...
    <body>
      ...
      <bodydDonate>
        <div class="containerDonate">
            ...
            <div class="card">
                <div class="imgBx">
                    <center><h3><b>Hi, I'm Amora!</b></h3></center>
        ...
        <div className="container-slider">
            {dataSlider.map((obj, index) => {
                return (
                    ...
                    >
                        <img 
                        src={process.env.PUBLIC_URL + `/Imgs/ImgsCat4/img${index + 1}.jpg`} 
                        />
                    </div>
                )
            })}
