    ...
    <body>
      ...
      <bodydDonate>
        <div class="containerDonate">
            ...
            <div class="card">
                <div class="imgBx">
                    <center><h3><b>Hi, I'm Kitty!</b></h3></center>
        ...
        <div className="container-slider">
            {dataSlider.map((obj, index) => {
                return (
                    ...
                    >
                        <img 
                        src={process.env.PUBLIC_URL + `/Imgs/ImgsCat2/img${index + 1}.jpg`} 
                        />
                    </div>
                )
            })}
        ...
        <div class="containerSlider">
            ...
            <div class="card">
                <div class="imgBx">
                    <center><h3><b>Name:</b>&nbsp;Kitty</h3></center>
                    ...
                    <center><h3>Loves to Sleep, Loves to play toys, Don't like to wear a collar</h3></center>
                </div>
            </div>
