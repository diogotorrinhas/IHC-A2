    ...
    <body>
      ...
      <bodydDonate>
        <div class="containerDonate">
            ...
            <div class="card">
                <div class="imgBx">
                    <center><h3><b>Hi, I'm Bob!</b></h3></center>
        ...
        <div className="container-slider">
            {dataSlider.map((obj, index) => {
                return (
                    ...
                    >
                        <img 
                        src={process.env.PUBLIC_URL + `/Imgs/ImgsCat3/img${index + 1}.jpg`} 
                        />
                    </div>
                )
            })}
        ...
        <div class="containerSlider">
            ...
            <div class="card">
                <div class="imgBx">
                    <center><h3><b>Name:</b>&nbsp;Bob</h3></center>
                    ...
                    <center><h3>Only eats animal food, Don't like to wear a collar</h3></center>
                </div>
            </div>
